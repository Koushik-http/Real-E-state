            ...
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="nri">NRI Buyer</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
              ...
              <div className="flex items-start space-x-2">
                ...
                <Label htmlFor="marketing" className="font-normal text-sm leading-tight">
                  I agree to receive marketing communications from EstateHub about new properties, special offers, and
                  market updates.
                </Label>
              </div>
            </div>
